...
use crate::{
    ...
    local::{
        ...
        net::{AutoProxyClientStream, udp::generate_client_session_id},
    },
    net::{FlowStat, MonProxySocket, packet_window::PacketWindowFilter},
};
...
impl DnsClient {
    ...
    pub async fn connect_tcp_remote(
        ...
        let stream = AutoProxyClientStream::connect_proxied_with_opts(
